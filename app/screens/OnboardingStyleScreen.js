...
const STYLE_OPTIONS = [
  { id: 'aesthetics',  label: 'aesthetics',    sub: 'looks, color schemes, clean desk vibes.' },
  { id: 'performance', label: 'performance',   sub: 'fps, specs, benchmarks, raw speed.' },
  { id: 'budget',      label: 'budget builds', sub: 'max value, smart spending.' },
  { id: 'minimalism',  label: 'minimalism',    sub: 'less is more, clean and simple.' },
  { id: 'rgb',         label: 'RGB / theming', sub: 'lighting, matching colors, full vibes.' },
];
...
export default function OnboardingStyleScreen({ onContinue, onBack }) {
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safe}>
        ...
        >
          ...
          <Text style={styles.subtitle}>we'll show you builds you'll actually love.</Text>
        ...
        <View style={styles.footer}>
          <TouchableOpacity
            ...
            onPress={() => selected.size > 0 && onContinue({ styles: [...selected] })}
