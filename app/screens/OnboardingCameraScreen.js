...
const CAMERA_GIF = require('../assets/camera.gif');
...
export default function OnboardingCameraScreen({ onContinue, onBack }) {
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.sheet}>
          <Text style={styles.eyebrow}>JOIN THE COMMUNITY</Text>
          <Text style={styles.title}>See what everyone else is running.</Text>
          <Text style={styles.body}>
            Follow creators, explore builds from around the world, and get inspired by how others set up their rigs.
          </Text>

          <View style={styles.stepsRow}>
            <StepCard number="1" label="Follow creators" />
            <StepCard number="2" label="Explore builds" />
            <StepCard number="3" label="Get inspired" />
          </View>
...
const styles = StyleSheet.create({
  ...
  gifWrapper: { width: '100%', aspectRatio: 1230 / 768, transform: [{ scale: 1.12 }], transformOrigin: 'bottom' },
  gif: { width: '100%', aspectRatio: 1230 / 768, backgroundColor: 'transparent' },
