...
const AI_INTRO = require('../assets/airevamp.gif');
const AI_LOOP  = require('../assets/airevamp_loop.gif');

const INTRO_DURATION_MS = 5700; // airevamp.gif is 5900ms — start fade 200ms before end
...
export default function OnboardingAIRevampScreen({ onContinue, onBack }) {
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.sheet}>
          <Text style={styles.eyebrow}>AI REVAMP</Text>
          <Text style={styles.title}>Let AI upgrade your setup.</Text>
          <Text style={styles.body}>
            Add your gear to your board, then let AI generate a photo of exactly how your setup could look.
          </Text>

          <View style={styles.stepsRow}>
            <StepCard number="1" label="Build your board" />
            <StepCard number="2" label="AI generates it" />
            <StepCard number="3" label="See the vision" />
          </View>
...
const styles = StyleSheet.create({
  ...
  gifWrapper: { width: 420, aspectRatio: 1230 / 768 },
  gif: { width: 420, aspectRatio: 1230 / 768, backgroundColor: 'transparent' },
